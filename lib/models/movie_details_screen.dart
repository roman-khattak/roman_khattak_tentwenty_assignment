...
//
//     final movieDetailsScreen = movieDetailsScreenFromJson(jsonString);

import 'dart:convert';

MovieDetailsScreen movieDetailsScreenFromJson(String str) => MovieDetailsScreen.fromJson(json.decode(str));

String movieDetailsScreenToJson(MovieDetailsScreen data) => json.encode(data.toJson());
...
class MovieDetailsScreen {
  ...
  factory MovieDetailsScreen.fromJson(Map<String, dynamic> json) => MovieDetailsScreen(
    adult: json["adult"],
